...
function seeorhide_input(seehidename) {
  ...
  if (x.type === "password") {
    ...
    x.type = "password";
    see.innerHTML = '<i class="fas fa-eye-slash"></i>';
  }
};
...
function library_game_open(library_game_id) {
  ...
  var game_image = maingameid.querySelector('.library-game-image').value;
  var game_name = maingameid.querySelector('.library-game-name').value;
  var game_platform = maingameid.querySelector('.library-game-platform').value;
  var game_login = maingameid.querySelector('.library-game-login').value;
  var game_password = maingameid.querySelector('.library-game-password').value;

  document.querySelector('.game-library-popup-image img').src = "images/games/" + game_image;
